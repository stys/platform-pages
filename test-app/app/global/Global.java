...
public class Global extends GlobalSettings {
    ...
    public void onStart(Application application) {
        ...
        if (0 == RevisionEntity.find.findRowCount()) {
        	...
        	Service<ContentResult, Selector, Page> service = Play.application().plugin(EditPlugin.class).getPageService();
            ...
            // Store test page 1
            service.put(new Selector(alice.namespace, alice.key), alice);
            ...
            // Store test page 2
            service.put(new Selector(bob.namespace, bob.key), bob);
        }
